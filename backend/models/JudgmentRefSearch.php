...
/**
 * JudgmentRefSearch represents the model behind the search form of `backend\models\JudgmentRef`.
 */
class JudgmentRefSearch extends JudgmentRef
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'doc_id', 'judgment_title', 'court_name', 'doc_id_ref', 'judgment_title_ref', 'court_name_ref', 'flag', 'exam_status'], 'safe'],
        ];
    }
