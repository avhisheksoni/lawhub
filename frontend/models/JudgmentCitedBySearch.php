...
/**
 * JudgmentCitedBySearch represents the model behind the search form of `frontend\models\JudgmentCitedBy`.
 */
class JudgmentCitedBySearch extends JudgmentCitedBy
{
    /**
     * {@inheritdoc}
     */
